...
const MK={
 "Detox":[
  ...
  {t:"משקה דגל תות־לואיזה",m:82,st:T.sig("מחית תות")}],
 "Revive":[
  {t:"חליטת Revive קרה — רגילה או מוגזת",m:81,st:T.tea},
  {t:"משקה דגל מנגו־סנצ׳ה",m:82,st:T.sig("מחית מנגו")}],
 "Energy":[
  {t:"חליטת Energy קרה — רגילה או מוגזת",m:81,st:T.tea}],
 "Consciousness":[
  {t:"חליטת יסמין־ליצ׳י",m:81,st:T.tea},
  {t:"גזוז ליצ׳י",m:85,st:["ממלאים כוס בקרח","מוסיפים 40 מ״ל מי ליצ׳י","מוסיפים 40 מ״ל תרכיז GT","משלימים בסודה (כ־150 מ״ל)","קישוט: 2 ליצ׳י טריים"]}],
 "American":[
  {t:"חליטת American קרה — רגילה או מוגזת",m:81,st:T.tea}],
 "Fresh":[
  {t:"חליטת Fresh",m:81,st:T.tea},
  {t:"לימונדת היביסקוס־ליים",m:79,st:T.lem},
  {t:"משקה דגל תפוח־היביסקוס",m:86,st:T.sig("מיץ תפוחים")},
  {t:"גזוז היביסקוס־תפוח",m:85,st:T.gaz("מיץ תפוחים")}],
 "Desertea":[
  {t:"חליטה מדברית",m:81,st:T.tea},
  {t:"לימונדה מדברית",m:79,st:T.lem},
  {t:"משקה דגל מדברי־אפרסק",m:82,st:T.sig("מחית אפרסק")},
  {t:"גזוז מדברי־אפרסק",m:83,st:T.gaz("מחית אפרסק")}],
 "Calm":[
  {t:"חליטת קמומיל־תפוח — רגילה או מוגזת",m:81,st:T.tea}],
 "Namastea":[
  {t:"אייס צ׳אי מסאלה קלאסי",m:77,st:["ממלאים כוס בקרח","משלימים ל־⅔ בחלב (כל חלב מתאים)","מוזגים 50 מ״ל תרכיז מסאלה GT","מכתירים בקצף חלב","מפזרים קינמון"]},
  {t:"צ׳אי מסאלה על קרח",m:82,st:["ממלאים כוס בקרח","משלימים ל־⅔ במים","מוזגים 50 מ״ל תרכיז מסאלה GT","מכתירים בקצף חלב נדיב"]},
  {t:"דירטי צ׳אי (עם אספרסו)",m:76,st:["מוציאים שוט אספרסו","ממלאים כוס בקרח","משלימים ל־⅔ בחלב","מוזגים 50 מ״ל מסאלה + האספרסו","מכתירים בקצף חלב"]},
  {t:"צ׳אי וטוניק תפוז מיובש",m:78,st:["ממלאים כוס בקרח","מוזגים 50 מ״ל תרכיז מסאלה GT","ממלאים בטוניק (כ־150 מ״ל)","מקשטים בפרוסת תפוז מיובש"]},
  {t:"טוניק ורדים ורוד",m:77,st:["ממלאים כוס בקרח","מוזגים 50 מ״ל תרכיז מסאלה GT","ממלאים בטוניק ורדים או אשכוליות (כ־150 מ״ל)"]},
  {t:"צ׳אי קולד פואם וניל",m:83,st:["ממלאים כוס בקרח","משלימים ל־⅔ במים","מוזגים 50 מ״ל תרכיז מסאלה GT","מכתירים בקצף קר וניל","מקשטים במקל וניל"]}]
};
...
const COLS=[{"n": "01", "t": "חליטות קרות", "he": "חליטות קרות", "drinks": [{"en": "Fresh", "he": "חליטת היביסקוס וליים", "d": "חליטת היביסקוס וליים, רגילה או מוגזת, עם לימון ונענע", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז GT", "משלימים ל־⅔ במים קרים (או סודה)", "קישוט: פרוסת לימון · נענע טרייה"], "ing": ["קרח", "50 מ״ל תרכיז GT", "פרוסת לימון", "עשבי קישוט"], "m": 81}, {"en": "Calm", "he": "חליטת קמומיל ותפוח", "d": "קמומיל, תפוח וציפורן · בלי קפאין, מרגיע", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז GT", "משלימים ל־⅔ במים קרים (או סודה)", "קישוט: פרוסת לימון · אזוב או נענע"], "ing": ["קרח", "50 מ״ל תרכיז GT", "פרוסת לימון", "עשבי קישוט"], "m": 81}, {"en": "Desertea", "he": "חליטה מדברית", "d": "לואיזה, נענע, אזוב, מרווה וזוטה לבנה · בלי קפאין", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז GT", "משלימים ל־⅔ במים קרים (או סודה)", "קישוט: פרוסת לימון · תערובת תבלינים"], "ing": ["קרח", "50 מ״ל תרכיז GT", "פרוסת לימון", "עשבי קישוט"], "m": 81}, {"en": "Revive", "he": "חליטת סנצ'ה ופסיפלורה", "d": "סנצ׳ה יפני ופסיפלורה · עם קפאין, מרענן", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז GT", "משלימים ל־⅔ במים קרים (או סודה)", "קישוט: פרוסת לימון · רוזמרין"], "ing": ["קרח", "50 מ״ל תרכיז GT", "פרוסת לימון", "עשבי קישוט"], "m": 81}, {"en": "Detox", "he": "חליטת תה ירוק לואיזה וליים", "d": "תה ירוק, לואיזה, נענע וליים", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז GT", "משלימים ל־⅔ במים קרים (או סודה)", "קישוט: פרוסת לימון · נענע טרייה"], "ing": ["קרח", "50 מ״ל תרכיז GT", "פרוסת לימון", "עשבי קישוט"], "m": 81}, {"en": "Energy", "he": "חליטת תה ירוק ולמון גראס", "d": "תה ירוק, למון גראס, נענע ולימון", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז GT", "משלימים ל־⅔ במים קרים (או סודה)", "קישוט: פרוסת לימון · בזיליקום"], "ing": ["קרח", "50 מ״ל תרכיז GT", "פרוסת לימון", "עשבי קישוט"], "m": 81}, {"en": "Consciousness", "he": "חליטת יסמין וליצ'י", "d": "תה יסמין וליצ׳י — רגיל או מוגז, ארומטי ועדין", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז GT", "משלימים ל־⅔ במים קרים (או סודה)", "קישוט: פרוסת לימון · נענע טרייה"], "ing": ["קרח", "50 מ״ל תרכיז GT", "פרוסת לימון", "עשבי קישוט"], "m": 81}], "ac": "var(--terra)"}, {"n": "02", "t": "לימונדות", "he": "לימונדות", "drinks": [{"en": "לימונדת Fresh", "he": "לימונדת היביסקוס וליים", "d": "לימונדת היביסקוס וליים מרעננת", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז GT", "משלימים עד למעלה בלימונדה", "מערבבים בעדינות ומגישים"], "ing": ["קרח", "50 מ״ל תרכיז GT", "~250 מ״ל לימונדה"], "m": 79}, {"en": "לימונדה מדברית", "he": "לימונדה מדברית", "d": "לימונדה על צמחי בר ישראליים", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז GT", "משלימים עד למעלה בלימונדה", "מערבבים בעדינות ומגישים"], "ing": ["קרח", "50 מ״ל תרכיז GT", "~250 מ״ל לימונדה"], "m": 79}, {"en": "לימונדת Namastea", "he": "לימונדת צ'אי מסאלה", "d": "לימונדה על צ׳אי מסאלה", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז GT", "משלימים עד למעלה בלימונדה", "מערבבים בעדינות ומגישים"], "ing": ["קרח", "50 מ״ל תרכיז GT", "~250 מ״ל לימונדה"], "m": 79}], "ac": "var(--energy)"}, {"n": "03", "t": "משקאות הדגל", "he": "משקאות הדגל", "drinks": [{"en": "מדברי אפרסק", "he": "חליטת אפרסק מדברית", "d": "משקה דגל על מחית אפרסק", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל מחית אפרסק", "מוסיפים 40 מ״ל תרכיז GT", "מוסיפים מים", "מקשטים לפי הטעם"], "ing": ["קרח", "40 מ״ל מחית אפרסק", "40 מ״ל תרכיז GT", "קישוט"], "m": 82}, {"en": "Detox תות", "he": "חליטת תות לואיזה", "d": "משקה דגל על מחית תות", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל מחית תות", "מוסיפים 40 מ״ל תרכיז GT", "משלימים ל־⅔ במים", "מקשטים לפי הטעם"], "ing": ["קרח", "40 מ״ל מחית תות", "40 מ״ל תרכיז GT", "קישוט"], "m": 82}, {"en": "Revive מנגו", "he": "חליטת מנגו סנצ'ה", "d": "משקה דגל על מנגו", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל מחית מנגו", "מוסיפים 40 מ״ל תרכיז GT", "משלימים ל־⅔ במים", "מקשטים לפי הטעם"], "ing": ["קרח", "40 מ״ל מחית מנגו", "40 מ״ל תרכיז GT", "קישוט"], "m": 82}, {"en": "Fresh תפוח", "he": "חליטת תפוח היביסקוס", "d": "משקה דגל על מיץ תפוחים", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל מיץ תפוחים", "מוסיפים 40 מ״ל תרכיז GT", "משלימים ל־⅔ במים", "מקשטים לפי הטעם"], "ing": ["קרח", "40 מ״ל מיץ תפוחים", "40 מ״ל תרכיז GT", "קישוט"], "m": 86}], "ac": "var(--revive)"}, {"n": "04", "t": "גזוז", "he": "גזוז", "drinks": [{"en": "Consciousness ליצ׳י", "he": "גזוז יסמין וליצ'י", "d": "גזוז תה יסמין וליצ׳י עם ליצ׳י טרי", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל מי ליצ׳י", "מוסיפים 40 מ״ל תרכיז GT", "משלימים ל־⅔ בסודה (כ־150 מ״ל)", "קישוט: 2 ליצ׳י"], "ing": ["קרח", "40 מ״ל מי ליצ׳י", "40 מ״ל תרכיז GT", "~150 מ״ל סודה", "2 ליצ׳י"], "m": 85}, {"en": "גזוז מדברי אפרסק", "he": "גזוז מדברי ואפרסק", "d": "גזוז צמחי בר ואפרסק", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל מחית אפרסק", "מוסיפים 40 מ״ל תרכיז GT", "משלימים ל־⅔ בסודה (כ־150 מ״ל)", "מקשטים לפי הטעם"], "ing": ["קרח", "40 מ״ל מחית אפרסק", "40 מ״ל תרכיז GT", "~150 מ״ל סודה"], "m": 83}, {"en": "גזוז Fresh תפוח", "he": "גזוז היביסקוס ותפוח", "d": "גזוז היביסקוס עם מיץ תפוחים", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל מיץ תפוחים", "מוסיפים 40 מ״ל תרכיז GT", "משלימים ל־⅔ בסודה (כ־150 מ״ל)", "מקשטים לפי הטעם"], "ing": ["קרח", "40 מ״ל מיץ תפוחים", "40 מ״ל תרכיז GT", "~150 מ״ל סודה"], "m": 85}], "ac": "#7FA8B8"}, {"n": "05", "t": "אייס מאצ׳ה", "he": "אייס מאצ'ה", "drinks": [{"en": "Classic", "he": "אייס מאצ'ה קלאסי", "d": "אייס מאצ׳ה קלאסי", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "⅔ כוס חלב", "50 מ״ל מאצ׳ה (1.8 גרם)", "70 מ״ל קצף חלב"], "m": 81}, {"en": "Mango", "he": "אייס מאצ'ה מנגו", "d": "אייס מאצ׳ה מנגו", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל מחית מנגו", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "40 מ״ל מחית מנגו", "⅔ כוס חלב", "50 מ״ל מאצ׳ה (1.8 גרם)", "70 מ״ל קצף חלב"], "m": 80}, {"en": "Strawberry", "he": "אייס מאצ'ה תות", "d": "אייס מאצ׳ה מחית תות", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל מחית תות", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "40 מ״ל מחית תות", "⅔ כוס חלב", "50 מ״ל מאצ׳ה (1.8 גרם)", "70 מ״ל קצף חלב"], "m": 80}, {"en": "Peach", "he": "אייס מאצ'ה אפרסק", "d": "אייס מאצ׳ה מחית אפרסק", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל מחית אפרסק", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "40 מ״ל מחית אפרסק", "⅔ כוס חלב", "50 מ״ל מאצ׳ה (1.8 גרם)", "70 מ״ל קצף חלב"], "m": 80}, {"en": "Massala", "he": "אייס מאצ'ה מסאלה", "d": "אייס מאצ׳ה עם תרכיז מסאלה GT", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל תרכיז מסאלה GT", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "40 מ״ל תרכיז מסאלה GT", "⅔ כוס חלב", "50 מ״ל מאצ׳ה (1.8 גרם)", "70 מ״ל קצף חלב"], "m": 78}, {"en": "אגבה על קרח", "he": "מאצ'ה אגבה על הקרח", "d": "אייס מאצ׳ה קליל עם אגבה על קרח", "st": ["ממלאים את הכוס בקרח", "מוסיפים 15 מ״ל סירופ אגבה", "משלימים ל־⅔ במים", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "⅔ כוס מים", "15 מ״ל סירופ אגבה", "50 מ״ל מאצ׳ה (1.8 גרם)", "70 מ״ל קצף חלב"], "m": 87}], "ac": "var(--matcha)"}, {"n": "06", "t": "מאצ׳ה ספיישל", "he": "מאצ'ה — טעמים מיוחדים", "drinks": [{"en": "Vanilla", "he": "אייס מאצ'ה וניל", "d": "אייס מאצ׳ה וניל", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים מקל וניל", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "⅔ כוס חלב", "50 מ״ל מאצ׳ה (1.8 גרם)", "מקל וניל", "70 מ״ל קצף חלב"], "m": 81}, {"en": "Pistachio", "he": "אייס מאצ'ה פיסטוק", "d": "אייס מאצ׳ה פיסטוק", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים פיסטוק גרוס", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "⅔ כוס חלב", "50 מ״ל מאצ׳ה (1.8 גרם)", "פיסטוק גרוס", "70 מ״ל קצף חלב"], "m": 77}, {"en": "שומשום שחור", "he": "אייס מאצ'ה שומשום שחור", "d": "אייס מאצ׳ה שומשום שחור", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים שומשום שחור", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "⅔ כוס חלב", "50 מ״ל מאצ׳ה (1.8 גרם)", "שומשום שחור", "70 מ״ל קצף חלב"], "m": 79}, {"en": "Coffee", "he": "אייס מאצ'ה קפה", "d": "אייס מאצ׳ה קפה", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים שוט אספרסו", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "⅔ כוס חלב", "50 מ״ל מאצ׳ה (1.8 גרם)", "שוט אספרסו", "70 מ״ל קצף חלב"], "m": 79}, {"en": "Banana", "he": "אייס מאצ'ה בננה", "d": "אייס מאצ׳ה בננה", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים מחית בננה", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "⅔ כוס חלב", "50 מ״ל מאצ׳ה (1.8 גרם)", "מחית בננה", "70 מ״ל קצף חלב"], "m": 80}], "ac": "#8C8C7A"}, {"n": "07", "t": "מאצ׳ה קוקוס", "he": "מאצ'ה קוקוס", "drinks": [{"en": "אגבה קלאסי", "he": "מאצ'ה קוקוס אגבה", "d": "מאצ׳ה קוקוס אגבה קלאסי", "st": ["ממלאים את הכוס בקרח", "מוסיפים 15 מ״ל סירופ אגבה", "משלימים ל־⅔ במי קוקוס (כ־150 מ״ל)", "מוסיפים קרם קוקוס (70 מ״ל)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)"], "ing": ["קרח", "15 מ״ל סירופ אגבה", "~150 מ״ל מי קוקוס", "70 מ״ל קרם קוקוס", "50 מ״ל מאצ׳ה (1.8 גרם)"], "m": 86}, {"en": "Lychee", "he": "מאצ'ה קוקוס ליצ'י", "d": "מאצ׳ה קוקוס ליצ׳י", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל מי ליצ׳י", "משלימים ל־⅔ במי קוקוס (כ־150 מ״ל)", "מוסיפים קרם קוקוס (70 מ״ל)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)"], "ing": ["קרח", "40 מ״ל מי ליצ׳י", "~150 מ״ל מי קוקוס", "70 מ״ל קרם קוקוס", "50 מ״ל מאצ׳ה (1.8 גרם)"], "m": 85}, {"en": "Strawberry", "he": "מאצ'ה קוקוס תות", "d": "מאצ׳ה קוקוס תות", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל מחית תות", "משלימים ל־⅔ במי קוקוס (כ־150 מ״ל)", "מוסיפים קרם קוקוס (70 מ״ל)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)"], "ing": ["קרח", "40 מ״ל מחית תות", "~150 מ״ל מי קוקוס", "70 מ״ל קרם קוקוס", "50 מ״ל מאצ׳ה (1.8 גרם)"], "m": 84}, {"en": "Mango", "he": "מאצ'ה קוקוס מנגו", "d": "מאצ׳ה קוקוס מנגו", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל מחית מנגו", "משלימים ל־⅔ במי קוקוס (כ־150 מ״ל)", "מוסיפים קרם קוקוס (70 מ״ל)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)"], "ing": ["קרח", "40 מ״ל מחית מנגו", "~150 מ״ל מי קוקוס", "70 מ״ל קרם קוקוס", "50 מ״ל מאצ׳ה (1.8 גרם)"], "m": 84}, {"en": "Peach", "he": "מאצ'ה קוקוס אפרסק", "d": "מאצ׳ה קוקוס אפרסק", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל מחית אפרסק", "משלימים ל־⅔ במי קוקוס (כ־150 מ״ל)", "מוסיפים קרם קוקוס (70 מ״ל)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)"], "ing": ["קרח", "40 מ״ל מחית אפרסק", "~150 מ״ל מי קוקוס", "70 מ״ל קרם קוקוס", "50 מ״ל מאצ׳ה (1.8 גרם)"], "m": 84}], "ac": "#5FA89B"}, {"n": "08", "t": "צ׳אי מסאלה", "he": "צ'אי מסאלה", "drinks": [{"en": "אייס מסאלה קלאסי", "he": "אייס צ'אי מסאלה קלאסי", "d": "צ׳אי מסאלה עשיר עם קצף חלב וקינמון", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל תרכיז מסאלה GT", "מוסיפים קצף חלב", "מפזרים קינמון"], "ing": ["קרח", "⅔ כוס חלב", "50 מ״ל מסאלה GT", "70 מ״ל קצף חלב", "קינמון"], "m": 77}, {"en": "על קרח", "he": "צ'אי מסאלה על הקרח", "d": "צ׳אי מסאלה קליל ומרענן על מים", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ במים", "מוזגים 50 מ״ל תרכיז מסאלה GT", "מוסיפים קצף חלב נדיב"], "ing": ["קרח", "⅔ כוס מים", "50 מ״ל מסאלה GT", "70 מ״ל קצף חלב"], "m": 82}, {"en": "דירטי צ׳אי", "he": "דירטי צ'אי", "d": "צ׳אי מסאלה עם שוט אספרסו וקצף חלב עשיר", "st": ["מכינים שוט אספרסו", "ממלאים את הכוס בקרח", "משלימים ל־⅔ בחלב", "מוזגים 50 מ״ל מסאלה GT + האספרסו", "מוסיפים קצף חלב נדיב"], "ing": ["קרח", "⅔ כוס חלב", "50 מ״ל מסאלה GT", "שוט אספרסו", "70 מ״ל קצף חלב"], "m": 76}, {"en": "טוניק תפוז מיובש", "he": "צ'אי מסאלה תפוז וטוניק", "d": "צ׳אי מסאלה מוגז עם טוניק ותפוז מיובש", "st": ["ממלאים את הכוס בקרח", "מוזגים 50 מ״ל תרכיז מסאלה GT", "משלימים בטוניק (כ־150 מ״ל)", "מקשטים בפרוסת תפוז מיובש"], "ing": ["קרח", "50 מ״ל מסאלה GT", "~150 מ״ל טוניק", "תפוז מיובש"], "m": 78}, {"en": "טוניק ורדים ורוד", "he": "צ'אי מסאלה פינק טוניק", "d": "צ׳אי מסאלה עם טוניק ורדים או אשכוליות", "st": ["ממלאים את הכוס בקרח", "מוזגים 50 מ״ל תרכיז מסאלה GT", "משלימים בטוניק ורדים או אשכוליות (כ־150 מ״ל)"], "ing": ["קרח", "50 מ״ל מסאלה GT", "~150 מ״ל טוניק ורדים"], "m": 77}, {"en": "מיץ תפוזים", "he": "צ'אי מסאלה ומיץ תפוזים", "d": "צ׳אי מסאלה עם מיץ תפוזים סחוט", "st": ["ממלאים את הכוס בקרח", "מוזגים 50 מ״ל תרכיז מסאלה GT", "משלימים במיץ תפוזים סחוט (כ־150 מ״ל)"], "ing": ["קרח", "50 מ״ל מסאלה GT", "~150 מ״ל מיץ תפוזים"], "m": 78}], "ac": "var(--nama)"}, {"n": "09", "t": "קולד פואם", "he": "צ'אי מסאלה קולד פואם", "drinks": [{"en": "Vanilla", "he": "צ'אי מסאלה קולד פואם וניל", "d": "צ׳אי מסאלה עם קצף קר וניל", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ במים", "מוזגים 50 מ״ל תרכיז מסאלה GT", "מכתירים בקצף קר וניל", "מקשטים במקל וניל"], "ing": ["קרח", "⅔ כוס מים", "50 מ״ל מסאלה GT", "70 מ״ל קצף קר", "תמצית וניל"], "m": 83}, {"en": "Pistachio", "he": "צ'אי מסאלה קולד פואם פיסטוק", "d": "צ׳אי מסאלה עם קצף קר ופיסטוק גרוס", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ בחלב", "מוזגים 50 מ״ל תרכיז מסאלה GT", "מכתירים בקצף קר חלבי", "מפזרים פיסטוק גרוס"], "ing": ["קרח", "⅔ כוס חלב", "50 מ״ל מסאלה GT", "70 מ״ל קצף קר", "פיסטוק גרוס"], "m": 81}, {"en": "קוקוס תאילנדי", "he": "צ'אי תאילנדי קוקוס קולד פואם", "d": "צ׳אי מסאלה עם קצף קר קוקוס, בסגנון תאילנדי", "st": ["ממלאים את הכוס בקרח", "משלימים במי קוקוס (כ־150 מ״ל)", "מוזגים 50 מ״ל תרכיז מסאלה GT", "מכתירים בקצף קר קוקוס (70 מ״ל)"], "ing": ["קרח", "~150 מ״ל מי קוקוס", "50 מ״ל מסאלה GT", "70 מ״ל קרם קוקוס"], "m": 82}, {"en": "Banana", "he": "צ'אי מסאלה קולד פואם בננה", "d": "צ׳אי מסאלה עם קצף קר בננה", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ בחלב", "מוזגים 50 מ״ל מסאלה GT + מחית בננה", "מכתירים בקצף קר חלבי"], "ing": ["קרח", "⅔ כוס חלב", "50 מ״ל מסאלה GT", "מחית בננה", "70 מ״ל קצף קר"], "m": 84}], "ac": "#B0793B"}, {"n": "10", "t": "אובה", "he": "אובה", "drinks": [{"en": "Strawberry", "he": "אייס אובה תות", "d": "אייס אובה תות", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל מחית תות", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל אובה מוכן (2 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "40 מ״ל מחית תות", "⅔ כוס חלב", "50 מ״ל אובה (2 גרם)", "70 מ״ל קצף חלב"], "m": 79}, {"en": "Mango", "he": "אייס אובה מנגו", "d": "אייס אובה מנגו", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל מחית מנגו", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל אובה מוכן (2 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "40 מ״ל מחית מנגו", "⅔ כוס חלב", "50 מ״ל אובה (2 גרם)", "70 מ״ל קצף חלב"], "m": 79}, {"en": "Peach", "he": "אייס אובה אפרסק", "d": "אייס אובה אפרסק", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל מחית אפרסק", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל אובה מוכן (2 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "40 מ״ל מחית אפרסק", "⅔ כוס חלב", "50 מ״ל אובה (2 גרם)", "70 מ״ל קצף חלב"], "m": 79}, {"en": "Massala", "he": "אייס אובה מסאלה", "d": "אייס אובה מסאלה", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז מסאלה GT", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל אובה מוכן (2 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "50 מ״ל מסאלה GT", "⅔ כוס חלב", "50 מ״ל אובה (2 גרם)", "70 מ״ל קצף חלב"], "m": 76}, {"en": "Matcha", "he": "אייס אובה מאצ'ה", "d": "אייס אובה מאצ׳ה", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל אובה מוכן (2 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "50 מ״ל מאצ׳ה (1.8 גרם)", "⅔ כוס חלב", "50 מ״ל אובה (2 גרם)", "70 מ״ל קצף חלב"], "m": 79}], "ac": "var(--ube)"}];

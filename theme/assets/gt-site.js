...
const FL={
 ...
 "American":"הקלאסיקה האמריקאית עם חוצפה ישראלית. תה מיושן ועמוק שמורם ביוזו, ברגמוט והדרים — ובן זוג מושלם לפירה אפרסק או מנגו מקו הסמוזי שלנו.",
...
const MK={
 "Detox":[
  {t:"חליטת Detox קרה — רגילה או מוגזת",p:19,m:77,fc:"3.76",st:T.tea},
  {t:"משקה דגל תות־לואיזה",p:24,m:73,fc:"5.41",st:T.sig("פירה תות")}],
 "Revive":[
  {t:"חליטת Revive קרה — רגילה או מוגזת",p:19,m:77,fc:"3.76",st:T.tea},
  {t:"משקה דגל מנגו־סנצ׳ה",p:24,m:73,fc:"5.41",st:T.sig("פירה מנגו")}],
 "Energy":[
  {t:"חליטת Energy קרה — רגילה או מוגזת",p:19,m:77,fc:"3.76",st:T.tea}],
 "Consciousness":[
  {t:"חליטת יסמין־ליצ׳י",p:19,m:77,fc:"3.76",st:T.tea},
  {t:"גזוז ליצ׳י",p:22,m:76,fc:"4.52",st:["ממלאים כוס בקרח","מוסיפים 40 מ״ל מי ליצ׳י","מוסיפים 40 מ״ל תרכיז GT","משלימים בסודה (כ־150 מ״ל)","קישוט: 2 ליצ׳י טריים"]}],
 "American":[
  {t:"חליטת American קרה — רגילה או מוגזת",p:19,m:77,fc:"3.76",st:T.tea}],
 "Fresh":[
  {t:"חליטת Fresh",p:19,m:77,fc:"3.76",st:T.tea},
  {t:"לימונדת היביסקוס־ליים",p:19,m:74,fc:"4.19",st:T.lem},
  {t:"משקה דגל תפוח־היביסקוס",p:24,m:84,fc:"3.25",st:T.sig("מיץ תפוחים")},
  {t:"גזוז היביסקוס־תפוח",p:22,m:81,fc:"3.62",st:T.gaz("מיץ תפוחים")}],
 "Desertea":[
  {t:"חליטה מדברית",p:19,m:77,fc:"3.76",st:T.tea},
  {t:"לימונדה מדברית",p:19,m:74,fc:"4.19",st:T.lem},
  {t:"משקה דגל מדברי־אפרסק",p:24,m:73,fc:"5.41",st:T.sig("פירה אפרסק")},
  {t:"גזוז מדברי־אפרסק",p:22,m:69,fc:"5.79",st:T.gaz("פירה אפרסק")}],
 "Calm":[
  {t:"חליטת קמומיל־תפוח — רגילה או מוגזת",p:19,m:77,fc:"3.76",st:T.tea}],
 "Namastea":[
  {t:"אייס צ׳אי מסאלה קלאסי",p:24,m:75,fc:"5.00",st:["ממלאים כוס בקרח","משלימים ל־⅔ בחלב (כל חלב מתאים)","מוזגים 50 מ״ל תרכיז מסאלה GT","מכתירים בקצף חלב","מפזרים קינמון"]},
  {t:"צ׳אי מסאלה על קרח",p:24,m:81,fc:"3.80",st:["ממלאים כוס בקרח","משלימים ל־⅔ במים","מוזגים 50 מ״ל תרכיז מסאלה GT","מכתירים בקצף חלב נדיב"]},
  {t:"דירטי צ׳אי (עם אספרסו)",p:24,m:72,fc:"5.65",st:["מוציאים שוט אספרסו","ממלאים כוס בקרח","משלימים ל־⅔ בחלב","מוזגים 50 מ״ל מסאלה + האספרסו","מכתירים בקצף חלב"]},
  {t:"צ׳אי וטוניק תפוז מיובש",p:24,m:77,fc:"4.76",st:["ממלאים כוס בקרח","מוזגים 50 מ״ל תרכיז מסאלה GT","ממלאים בטוניק (כ־150 מ״ל)","מקשטים בפרוסת תפוז מיובש"]},
  {t:"טוניק ורדים ורוד",p:24,m:78,fc:"4.51",st:["ממלאים כוס בקרח","מוזגים 50 מ״ל תרכיז מסאלה GT","ממלאים בטוניק ורדים או אשכוליות (כ־150 מ״ל)"]},
  {t:"צ׳אי קולד פואם וניל",p:28,m:83,fc:"3.95",st:["ממלאים כוס בקרח","משלימים ל־⅔ במים","מוזגים 50 מ״ל תרכיז מסאלה GT","מכתירים בקצף קר וניל","מקשטים במקל וניל"]}]
};
const MKMORE={"Hojicha":"מוגש בשתי הדרכים — הוג׳יצ׳ה לאטה חם עם כל חלב, או קר על חלב. נימות קלויות של אגוזי לוז וקקאו.","American":"משתלב מושלם עם פירה אפרסק ומנגו של ODK — הבסיס למשקאות הדגל.","Energy":"כל חליטה קרה היא גם גזוז: אותו מתכון, סודה במקום מים.","Calm":"כל חליטה קרה היא גם גזוז: אותו מתכון, סודה במקום מים."};
...
const COLS=[{"n": "01", "t": "חליטות קרות", "he": "חליטות קרות", "p": "₪19", "drinks": [{"en": "Fresh", "he": "חליטת היביסקוס וליים", "d": "חליטת היביסקוס וליים, רגילה או מוגזת, עם לימון ונענע", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז GT", "משלימים ל־⅔ במים קרים (או סודה)", "קישוט: פרוסת לימון · נענע טרייה"], "ing": ["קרח", "50 מ״ל תרכיז GT", "פרוסת לימון", "עשבי קישוט"], "fc": "3.76", "p": 19, "m": 77, "pr": "12.34"}, {"en": "Calm", "he": "חליטת קמומיל ותפוח", "d": "קמומיל, תפוח וציפורן · בלי קפאין, מרגיע", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז GT", "משלימים ל־⅔ במים קרים (או סודה)", "קישוט: פרוסת לימון · אזוב או נענע"], "ing": ["קרח", "50 מ״ל תרכיז GT", "פרוסת לימון", "עשבי קישוט"], "fc": "3.76", "p": 19, "m": 77, "pr": "12.34"}, {"en": "Desertea", "he": "חליטה מדברית", "d": "לואיזה, נענע, אזוב, מרווה וזוטה לבנה · בלי קפאין", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז GT", "משלימים ל־⅔ במים קרים (או סודה)", "קישוט: פרוסת לימון · תערובת תבלינים"], "ing": ["קרח", "50 מ״ל תרכיז GT", "פרוסת לימון", "עשבי קישוט"], "fc": "3.76", "p": 19, "m": 77, "pr": "12.34"}, {"en": "Revive", "he": "חליטת סנצ'ה ופסיפלורה", "d": "סנצ׳ה יפני ופסיפלורה · עם קפאין, מרענן", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז GT", "משלימים ל־⅔ במים קרים (או סודה)", "קישוט: פרוסת לימון · רוזמרין"], "ing": ["קרח", "50 מ״ל תרכיז GT", "פרוסת לימון", "עשבי קישוט"], "fc": "3.76", "p": 19, "m": 77, "pr": "12.34"}, {"en": "Detox", "he": "חליטת תה ירוק לואיזה וליים", "d": "תה ירוק, לואיזה, נענע וליים", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז GT", "משלימים ל־⅔ במים קרים (או סודה)", "קישוט: פרוסת לימון · נענע טרייה"], "ing": ["קרח", "50 מ״ל תרכיז GT", "פרוסת לימון", "עשבי קישוט"], "fc": "3.76", "p": 19, "m": 77, "pr": "12.34"}, {"en": "Energy", "he": "חליטת תה ירוק ולמון גראס", "d": "תה ירוק, למון גראס, נענע ולימון", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז GT", "משלימים ל־⅔ במים קרים (או סודה)", "קישוט: פרוסת לימון · בזיליקום"], "ing": ["קרח", "50 מ״ל תרכיז GT", "פרוסת לימון", "עשבי קישוט"], "fc": "3.76", "p": 19, "m": 77, "pr": "12.34"}, {"en": "Consciousness", "he": "חליטת יסמין וליצ'י", "d": "תה יסמין וליצ׳י — רגיל או מוגז, ארומטי ועדין", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז GT", "משלימים ל־⅔ במים קרים (או סודה)", "קישוט: פרוסת לימון · נענע טרייה"], "ing": ["קרח", "50 מ״ל תרכיז GT", "פרוסת לימון", "עשבי קישוט"], "fc": "3.76", "p": 19, "m": 77, "pr": "12.34"}], "ac": "var(--terra)"}, {"n": "02", "t": "לימונדות", "he": "לימונדות", "p": "₪19", "drinks": [{"en": "לימונדת Fresh", "he": "לימונדת היביסקוס וליים", "d": "לימונדת היביסקוס וליים מרעננת", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז GT", "משלימים עד למעלה בלימונדה", "מערבבים בעדינות ומגישים"], "ing": ["קרח", "50 מ״ל תרכיז GT", "~250 מ״ל לימונדה"], "fc": "4.19", "p": 19, "m": 74, "pr": "11.91"}, {"en": "לימונדה מדברית", "he": "לימונדה מדברית", "d": "לימונדה על צמחי בר ישראליים", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז GT", "משלימים עד למעלה בלימונדה", "מערבבים בעדינות ומגישים"], "ing": ["קרח", "50 מ״ל תרכיז GT", "~250 מ״ל לימונדה"], "fc": "4.19", "p": 19, "m": 74, "pr": "11.91"}, {"en": "לימונדת Namastea", "he": "לימונדת צ'אי מסאלה", "d": "לימונדה על צ׳אי מסאלה", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז GT", "משלימים עד למעלה בלימונדה", "מערבבים בעדינות ומגישים"], "ing": ["קרח", "50 מ״ל תרכיז GT", "~250 מ״ל לימונדה"], "fc": "4.19", "p": 19, "m": 74, "pr": "11.91"}], "ac": "var(--energy)"}, {"n": "03", "t": "משקאות הדגל", "he": "משקאות הדגל", "p": "₪24", "drinks": [{"en": "מדברי אפרסק", "he": "חליטת אפרסק מדברית", "d": "משקה דגל על פירה אפרסק", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל פירה אפרסק", "מוסיפים 40 מ״ל תרכיז GT", "מוסיפים מים", "מקשטים לפי הטעם"], "ing": ["קרח", "40 מ״ל פירה אפרסק", "40 מ״ל תרכיז GT", "קישוט"], "fc": "5.41", "p": 24, "m": 73, "pr": "14.93"}, {"en": "Detox תות", "he": "חליטת תות לואיזה", "d": "משקה דגל על פירה תות", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל פירה תות", "מוסיפים 40 מ״ל תרכיז GT", "משלימים ל־⅔ במים", "מקשטים לפי הטעם"], "ing": ["קרח", "40 מ״ל פירה תות", "40 מ״ל תרכיז GT", "קישוט"], "fc": "5.41", "p": 24, "m": 73, "pr": "14.93"}, {"en": "Revive מנגו", "he": "חליטת מנגו סנצ'ה", "d": "משקה דגל על מנגו", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל פירה מנגו", "מוסיפים 40 מ״ל תרכיז GT", "משלימים ל־⅔ במים", "מקשטים לפי הטעם"], "ing": ["קרח", "40 מ״ל פירה מנגו", "40 מ״ל תרכיז GT", "קישוט"], "fc": "5.41", "p": 24, "m": 73, "pr": "14.93"}, {"en": "Fresh תפוח", "he": "חליטת תפוח היביסקוס", "d": "משקה דגל על מיץ תפוחים", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל מיץ תפוחים", "מוסיפים 40 מ״ל תרכיז GT", "משלימים ל־⅔ במים", "מקשטים לפי הטעם"], "ing": ["קרח", "40 מ״ל מיץ תפוחים", "40 מ״ל תרכיז GT", "קישוט"], "fc": "3.25", "p": 24, "m": 84, "pr": "17.09"}], "ac": "var(--revive)"}, {"n": "04", "t": "גזוז", "he": "גזוז", "p": "₪22", "drinks": [{"en": "Consciousness ליצ׳י", "he": "גזוז יסמין וליצ'י", "d": "גזוז תה יסמין וליצ׳י עם ליצ׳י טרי", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל מי ליצ׳י", "מוסיפים 40 מ״ל תרכיז GT", "משלימים ל־⅔ בסודה (כ־150 מ״ל)", "קישוט: 2 ליצ׳י"], "ing": ["קרח", "40 מ״ל מי ליצ׳י", "40 מ״ל תרכיז GT", "~150 מ״ל סודה", "2 ליצ׳י"], "fc": "4.52", "p": 22, "m": 76, "pr": "14.12"}, {"en": "גזוז מדברי אפרסק", "he": "גזוז מדברי ואפרסק", "d": "גזוז צמחי בר ואפרסק", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל פירה אפרסק", "מוסיפים 40 מ״ל תרכיז GT", "משלימים ל־⅔ בסודה (כ־150 מ״ל)", "מקשטים לפי הטעם"], "ing": ["קרח", "40 מ״ל פירה אפרסק", "40 מ״ל תרכיז GT", "~150 מ״ל סודה"], "fc": "5.79", "p": 22, "m": 69, "pr": "12.85"}, {"en": "גזוז Fresh תפוח", "he": "גזוז היביסקוס ותפוח", "d": "גזוז היביסקוס עם מיץ תפוחים", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל מיץ תפוחים", "מוסיפים 40 מ״ל תרכיז GT", "משלימים ל־⅔ בסודה (כ־150 מ״ל)", "מקשטים לפי הטעם"], "ing": ["קרח", "40 מ״ל מיץ תפוחים", "40 מ״ל תרכיז GT", "~150 מ״ל סודה"], "fc": "3.62", "p": 22, "m": 81, "pr": "15.02"}], "ac": "#7FA8B8"}, {"n": "05", "t": "אייס מאצ׳ה", "he": "אייס מאצ'ה", "p": "₪26", "drinks": [{"en": "Classic", "he": "אייס מאצ'ה קלאסי", "d": "אייס מאצ׳ה קלאסי", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "⅔ כוס חלב", "50 מ״ל מאצ׳ה (1.8 גרם)", "70 מ״ל קצף חלב"], "fc": "3.77", "p": 26, "m": 83, "pr": "18.26"}, {"en": "Mango", "he": "אייס מאצ'ה מנגו", "d": "אייס מאצ׳ה מנגו", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל פירה מנגו", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "40 מ״ל פירה מנגו", "⅔ כוס חלב", "50 מ״ל מאצ׳ה (1.8 גרם)", "70 מ״ל קצף חלב"], "fc": "6.17", "p": 26, "m": 72, "pr": "15.86"}, {"en": "Strawberry", "he": "אייס מאצ'ה תות", "d": "אייס מאצ׳ה פירה תות", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל פירה תות", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "40 מ״ל פירה תות", "⅔ כוס חלב", "50 מ״ל מאצ׳ה (1.8 גרם)", "70 מ״ל קצף חלב"], "fc": "6.17", "p": 26, "m": 72, "pr": "15.86"}, {"en": "Peach", "he": "אייס מאצ'ה אפרסק", "d": "אייס מאצ׳ה פירה אפרסק", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל פירה אפרסק", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "40 מ״ל פירה אפרסק", "⅔ כוס חלב", "50 מ״ל מאצ׳ה (1.8 גרם)", "70 מ״ל קצף חלב"], "fc": "6.17", "p": 26, "m": 72, "pr": "15.86"}, {"en": "Massala", "he": "אייס מאצ'ה מסאלה", "d": "אייס מאצ׳ה עם תרכיז מסאלה GT", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל תרכיז מסאלה GT", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "40 מ״ל תרכיז מסאלה GT", "⅔ כוס חלב", "50 מ״ל מאצ׳ה (1.8 גרם)", "70 מ״ל קצף חלב"], "fc": "6.37", "p": 26, "m": 71, "pr": "15.66"}, {"en": "אגבה על קרח", "he": "מאצ'ה אגבה על הקרח", "d": "אייס מאצ׳ה קליל עם אגבה על קרח", "st": ["ממלאים את הכוס בקרח", "מוסיפים 15 מ״ל סירופ אגבה", "משלימים ל־⅔ במים", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "⅔ כוס מים", "15 מ״ל סירופ אגבה", "50 מ״ל מאצ׳ה (1.8 גרם)", "70 מ״ל קצף חלב"], "fc": "3.35", "p": 26, "m": 85, "pr": "18.68"}], "ac": "var(--matcha)"}, {"n": "06", "t": "מאצ׳ה ספיישל", "he": "מאצ'ה — טעמים מיוחדים", "p": "₪28", "drinks": [{"en": "Vanilla", "he": "אייס מאצ'ה וניל", "d": "אייס מאצ׳ה וניל", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים מקל וניל", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "⅔ כוס חלב", "50 מ״ל מאצ׳ה (1.8 גרם)", "מקל וניל", "70 מ״ל קצף חלב"], "fc": "5.97", "p": 28, "m": 75, "pr": "17.76"}, {"en": "Pistachio", "he": "אייס מאצ'ה פיסטוק", "d": "אייס מאצ׳ה פיסטוק", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים פיסטוק גרוס", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "⅔ כוס חלב", "50 מ״ל מאצ׳ה (1.8 גרם)", "פיסטוק גרוס", "70 מ״ל קצף חלב"], "fc": "4.32", "p": 28, "m": 82, "pr": "19.41"}, {"en": "שומשום שחור", "he": "אייס מאצ'ה שומשום שחור", "d": "אייס מאצ׳ה שומשום שחור", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים שומשום שחור", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "⅔ כוס חלב", "50 מ״ל מאצ׳ה (1.8 גרם)", "שומשום שחור", "70 מ״ל קצף חלב"], "fc": "3.92", "p": 28, "m": 83, "pr": "19.81"}, {"en": "Coffee", "he": "אייס מאצ'ה קפה", "d": "אייס מאצ׳ה קפה", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים שוט אספרסו", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "⅔ כוס חלב", "50 מ״ל מאצ׳ה (1.8 גרם)", "שוט אספרסו", "70 מ״ל קצף חלב"], "fc": "4.52", "p": 28, "m": 81, "pr": "19.21"}, {"en": "Banana", "he": "אייס מאצ'ה בננה", "d": "אייס מאצ׳ה בננה", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים פירה בננה", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "⅔ כוס חלב", "50 מ״ל מאצ׳ה (1.8 גרם)", "פירה בננה", "70 מ״ל קצף חלב"], "fc": "4.37", "p": 28, "m": 82, "pr": "19.36"}], "ac": "#8C8C7A"}, {"n": "07", "t": "מאצ׳ה קוקוס", "he": "מאצ'ה קוקוס", "p": "₪28", "drinks": [{"en": "אגבה קלאסי", "he": "מאצ'ה קוקוס אגבה", "d": "מאצ׳ה קוקוס אגבה קלאסי", "st": ["ממלאים את הכוס בקרח", "מוסיפים 15 מ״ל סירופ אגבה", "משלימים ל־⅔ במי קוקוס (כ־150 מ״ל)", "מוסיפים קרם קוקוס (70 מ״ל)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)"], "ing": ["קרח", "15 מ״ל סירופ אגבה", "~150 מ״ל מי קוקוס", "70 מ״ל קרם קוקוס", "50 מ״ל מאצ׳ה (1.8 גרם)"], "fc": "5.33", "p": 28, "m": 78, "pr": "18.40"}, {"en": "Lychee", "he": "מאצ'ה קוקוס ליצ'י", "d": "מאצ׳ה קוקוס ליצ׳י", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל מי ליצ׳י", "משלימים ל־⅔ במי קוקוס (כ־150 מ״ל)", "מוסיפים קרם קוקוס (70 מ״ל)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)"], "ing": ["קרח", "40 מ״ל מי ליצ׳י", "~150 מ״ל מי קוקוס", "70 מ״ל קרם קוקוס", "50 מ״ל מאצ׳ה (1.8 גרם)"], "fc": "5.14", "p": 28, "m": 78, "pr": "18.59"}, {"en": "Strawberry", "he": "מאצ'ה קוקוס תות", "d": "מאצ׳ה קוקוס תות", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל פירה תות", "משלימים ל־⅔ במי קוקוס (כ־150 מ״ל)", "מוסיפים קרם קוקוס (70 מ״ל)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)"], "ing": ["קרח", "40 מ״ל פירה תות", "~150 מ״ל מי קוקוס", "70 מ״ל קרם קוקוס", "50 מ״ל מאצ׳ה (1.8 גרם)"], "fc": "7.06", "p": 28, "m": 70, "pr": "16.67"}, {"en": "Mango", "he": "מאצ'ה קוקוס מנגו", "d": "מאצ׳ה קוקוס מנגו", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל פירה מנגו", "משלימים ל־⅔ במי קוקוס (כ־150 מ״ל)", "מוסיפים קרם קוקוס (70 מ״ל)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)"], "ing": ["קרח", "40 מ״ל פירה מנגו", "~150 מ״ל מי קוקוס", "70 מ״ל קרם קוקוס", "50 מ״ל מאצ׳ה (1.8 גרם)"], "fc": "7.06", "p": 28, "m": 70, "pr": "16.67"}, {"en": "Peach", "he": "מאצ'ה קוקוס אפרסק", "d": "מאצ׳ה קוקוס אפרסק", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל פירה אפרסק", "משלימים ל־⅔ במי קוקוס (כ־150 מ״ל)", "מוסיפים קרם קוקוס (70 מ״ל)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)"], "ing": ["קרח", "40 מ״ל פירה אפרסק", "~150 מ״ל מי קוקוס", "70 מ״ל קרם קוקוס", "50 מ״ל מאצ׳ה (1.8 גרם)"], "fc": "7.06", "p": 28, "m": 70, "pr": "16.67"}], "ac": "#5FA89B"}, {"n": "08", "t": "צ׳אי מסאלה", "he": "צ'אי מסאלה", "p": "₪24", "drinks": [{"en": "אייס מסאלה קלאסי", "he": "אייס צ'אי מסאלה קלאסי", "d": "צ׳אי מסאלה עשיר עם קצף חלב וקינמון", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל תרכיז מסאלה GT", "מוסיפים קצף חלב", "מפזרים קינמון"], "ing": ["קרח", "⅔ כוס חלב", "50 מ״ל מסאלה GT", "70 מ״ל קצף חלב", "קינמון"], "fc": "5.00", "p": 24, "m": 75, "pr": "15.34"}, {"en": "על קרח", "he": "צ'אי מסאלה על הקרח", "d": "צ׳אי מסאלה קליל ומרענן על מים", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ במים", "מוזגים 50 מ״ל תרכיז מסאלה GT", "מוסיפים קצף חלב נדיב"], "ing": ["קרח", "⅔ כוס מים", "50 מ״ל מסאלה GT", "70 מ״ל קצף חלב"], "fc": "3.80", "p": 24, "m": 81, "pr": "16.54"}, {"en": "דירטי צ׳אי", "he": "דירטי צ'אי", "d": "צ׳אי מסאלה עם שוט אספרסו וקצף חלב עשיר", "st": ["מכינים שוט אספרסו", "ממלאים את הכוס בקרח", "משלימים ל־⅔ בחלב", "מוזגים 50 מ״ל מסאלה GT + האספרסו", "מוסיפים קצף חלב נדיב"], "ing": ["קרח", "⅔ כוס חלב", "50 מ״ל מסאלה GT", "שוט אספרסו", "70 מ״ל קצף חלב"], "fc": "5.65", "p": 24, "m": 72, "pr": "14.69"}, {"en": "טוניק תפוז מיובש", "he": "צ'אי מסאלה תפוז וטוניק", "d": "צ׳אי מסאלה מוגז עם טוניק ותפוז מיובש", "st": ["ממלאים את הכוס בקרח", "מוזגים 50 מ״ל תרכיז מסאלה GT", "משלימים בטוניק (כ־150 מ״ל)", "מקשטים בפרוסת תפוז מיובש"], "ing": ["קרח", "50 מ״ל מסאלה GT", "~150 מ״ל טוניק", "תפוז מיובש"], "fc": "4.76", "p": 24, "m": 77, "pr": "15.58"}, {"en": "טוניק ורדים ורוד", "he": "צ'אי מסאלה פינק טוניק", "d": "צ׳אי מסאלה עם טוניק ורדים או אשכוליות", "st": ["ממלאים את הכוס בקרח", "מוזגים 50 מ״ל תרכיז מסאלה GT", "משלימים בטוניק ורדים או אשכוליות (כ־150 מ״ל)"], "ing": ["קרח", "50 מ״ל מסאלה GT", "~150 מ״ל טוניק ורדים"], "fc": "4.51", "p": 24, "m": 78, "pr": "15.83"}, {"en": "מיץ תפוזים", "he": "צ'אי מסאלה ומיץ תפוזים", "d": "צ׳אי מסאלה עם מיץ תפוזים סחוט", "st": ["ממלאים את הכוס בקרח", "מוזגים 50 מ״ל תרכיז מסאלה GT", "משלימים במיץ תפוזים סחוט (כ־150 מ״ל)"], "ing": ["קרח", "50 מ״ל מסאלה GT", "~150 מ״ל מיץ תפוזים"], "fc": "5.11", "p": 24, "m": 75, "pr": "15.23"}], "ac": "var(--nama)"}, {"n": "09", "t": "קולד פואם", "he": "צ'אי מסאלה קולד פואם", "p": "₪28", "drinks": [{"en": "Vanilla", "he": "צ'אי מסאלה קולד פואם וניל", "d": "צ׳אי מסאלה עם קצף קר וניל", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ במים", "מוזגים 50 מ״ל תרכיז מסאלה GT", "מכתירים בקצף קר וניל", "מקשטים במקל וניל"], "ing": ["קרח", "⅔ כוס מים", "50 מ״ל מסאלה GT", "70 מ״ל קצף קר", "תמצית וניל"], "fc": "3.95", "p": 28, "m": 83, "pr": "19.78"}, {"en": "Pistachio", "he": "צ'אי מסאלה קולד פואם פיסטוק", "d": "צ׳אי מסאלה עם קצף קר ופיסטוק גרוס", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ בחלב", "מוזגים 50 מ״ל תרכיז מסאלה GT", "מכתירים בקצף קר חלבי", "מפזרים פיסטוק גרוס"], "ing": ["קרח", "⅔ כוס חלב", "50 מ״ל מסאלה GT", "70 מ״ל קצף קר", "פיסטוק גרוס"], "fc": "5.45", "p": 28, "m": 77, "pr": "18.28"}, {"en": "קוקוס תאילנדי", "he": "צ'אי תאילנדי קוקוס קולד פואם", "d": "צ׳אי מסאלה עם קצף קר קוקוס, בסגנון תאילנדי", "st": ["ממלאים את הכוס בקרח", "משלימים במי קוקוס (כ־150 מ״ל)", "מוזגים 50 מ״ל תרכיז מסאלה GT", "מכתירים בקצף קר קוקוס (70 מ״ל)"], "ing": ["קרח", "~150 מ״ל מי קוקוס", "50 מ״ל מסאלה GT", "70 מ״ל קרם קוקוס"], "fc": "5.79", "p": 28, "m": 76, "pr": "17.94"}, {"en": "Banana", "he": "צ'אי מסאלה קולד פואם בננה", "d": "צ׳אי מסאלה עם קצף קר בננה", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ בחלב", "מוזגים 50 מ״ל מסאלה GT + פירה בננה", "מכתירים בקצף קר חלבי"], "ing": ["קרח", "⅔ כוס חלב", "50 מ״ל מסאלה GT", "פירה בננה", "70 מ״ל קצף קר"], "fc": "5.50", "p": 28, "m": 77, "pr": "18.23"}], "ac": "#B0793B"}, {"n": "10", "t": "אובה", "he": "אובה", "p": "₪28", "drinks": [{"en": "Strawberry", "he": "אייס אובה תות", "d": "אייס אובה תות", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל פירה תות", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל אובה מוכן (2 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "40 מ״ל פירה תות", "⅔ כוס חלב", "50 מ״ל אובה (2 גרם)", "70 מ״ל קצף חלב"], "fc": "4.73", "p": 28, "m": 80, "pr": "19.00"}, {"en": "Mango", "he": "אייס אובה מנגו", "d": "אייס אובה מנגו", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל פירה מנגו", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל אובה מוכן (2 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "40 מ״ל פירה מנגו", "⅔ כוס חלב", "50 מ״ל אובה (2 גרם)", "70 מ״ל קצף חלב"], "fc": "4.73", "p": 28, "m": 80, "pr": "19.00"}, {"en": "Peach", "he": "אייס אובה אפרסק", "d": "אייס אובה אפרסק", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל פירה אפרסק", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל אובה מוכן (2 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "40 מ״ל פירה אפרסק", "⅔ כוס חלב", "50 מ״ל אובה (2 גרם)", "70 מ״ל קצף חלב"], "fc": "4.73", "p": 28, "m": 80, "pr": "19.00"}, {"en": "Massala", "he": "אייס אובה מסאלה", "d": "אייס אובה מסאלה", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז מסאלה GT", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל אובה מוכן (2 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "50 מ״ל מסאלה GT", "⅔ כוס חלב", "50 מ״ל אובה (2 גרם)", "70 מ״ל קצף חלב"], "fc": "5.58", "p": 28, "m": 76, "pr": "18.15"}, {"en": "Matcha", "he": "אייס אובה מאצ'ה", "d": "אייס אובה מאצ׳ה", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל אובה מוכן (2 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "50 מ״ל מאצ׳ה (1.8 גרם)", "⅔ כוס חלב", "50 מ״ל אובה (2 גרם)", "70 מ״ל קצף חלב"], "fc": "4.45", "p": 28, "m": 81, "pr": "19.28"}], "ac": "var(--ube)"}];
...
function buildMatrix(){
 ...
 var NOTE={"American":"בסיס למשקה דגל — משתלב עם פירה אפרסק ומנגו של ODK.",
...
const PUREES={"mango": {"t": "Mango", "d": "פירה מנגו בסגנון אלפונסו זהוב — שכבת השמש למשקאות הדגל, למאצ׳ה, לקוקוס ולאובה.", "drinks": [["משקה דגל Revive מנגו", 2, 2], ["אייס מאצ׳ה מנגו", 4, 1], ["מאצ׳ה קוקוס מנגו", 6, 3], ["אייס אובה מנגו", 9, 1]]}, "strawberry": {"t": "Strawberry", "d": "פירה תות אדום ובשל — שכבת רב המכר לאורך כל תפריט הקיץ.", "drinks": [["משקה דגל Detox תות", 2, 1], ["אייס מאצ׳ה תות", 4, 2], ["מאצ׳ה קוקוס תות", 6, 2], ["אייס אובה תות", 9, 0]]}, "peach": {"t": "Peach", "d": "פירה אפרסק קטיפתי — הכוכב של המדברי־אפרסק: משקה דגל, גזוז, מאצ׳ה ואובה.", "drinks": [["משקה דגל מדברי אפרסק", 2, 0], ["גזוז מדברי אפרסק", 3, 1], ["אייס מאצ׳ה אפרסק", 4, 3], ["אייס אובה אפרסק", 9, 2]]}};
...
function pmOpen(id){
 ...
 document.getElementById('pm-title').textContent=p.t+'פירה · לאן זה הולך';

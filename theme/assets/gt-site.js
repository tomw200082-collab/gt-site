...
const MK={
 "Detox":[
  ...
  {t:"משקה דגל תות־לואיזה",p:31,m:82,fc:"4.80",st:T.sig("פירה תות")}],
 "Revive":[
  {t:"חליטת Revive קרה — רגילה או מוגזת",p:20,m:81,fc:"3.25",st:T.tea},
  {t:"משקה דגל מנגו־סנצ׳ה",p:31,m:82,fc:"4.80",st:T.sig("פירה מנגו")}],
 "Energy":[
 ...
 "Desertea":[
  ...
  {t:"משקה דגל מדברי־אפרסק",p:31,m:82,fc:"4.80",st:T.sig("פירה אפרסק")},
  {t:"גזוז מדברי־אפרסק",p:33,m:83,fc:"4.80",st:T.gaz("פירה אפרסק")}],
 "Calm":[
...
const COLS=[{"n": "01", "t": "חליטות קרות", "he": "חליטות קרות", "p": "₪20", "drinks": [{"en": "Fresh", "he": "חליטת היביסקוס וליים", "d": "חליטת היביסקוס וליים, רגילה או מוגזת, עם לימון ונענע", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז GT", "משלימים ל־⅔ במים קרים (או סודה)", "קישוט: פרוסת לימון · נענע טרייה"], "ing": ["קרח", "50 מ״ל תרכיז GT", "פרוסת לימון", "עשבי קישוט"], "fc": "3.25", "p": 20, "m": 81, "pr": "13.70"}, {"en": "Calm", "he": "חליטת קמומיל ותפוח", "d": "קמומיל, תפוח וציפורן · בלי קפאין, מרגיע", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז GT", "משלימים ל־⅔ במים קרים (או סודה)", "קישוט: פרוסת לימון · אזוב או נענע"], "ing": ["קרח", "50 מ״ל תרכיז GT", "פרוסת לימון", "עשבי קישוט"], "fc": "3.25", "p": 20, "m": 81, "pr": "13.70"}, {"en": "Desertea", "he": "חליטה מדברית", "d": "לואיזה, נענע, אזוב, מרווה וזוטה לבנה · בלי קפאין", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז GT", "משלימים ל־⅔ במים קרים (או סודה)", "קישוט: פרוסת לימון · תערובת תבלינים"], "ing": ["קרח", "50 מ״ל תרכיז GT", "פרוסת לימון", "עשבי קישוט"], "fc": "3.25", "p": 20, "m": 81, "pr": "13.70"}, {"en": "Revive", "he": "חליטת סנצ'ה ופסיפלורה", "d": "סנצ׳ה יפני ופסיפלורה · עם קפאין, מרענן", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז GT", "משלימים ל־⅔ במים קרים (או סודה)", "קישוט: פרוסת לימון · רוזמרין"], "ing": ["קרח", "50 מ״ל תרכיז GT", "פרוסת לימון", "עשבי קישוט"], "fc": "3.25", "p": 20, "m": 81, "pr": "13.70"}, {"en": "Detox", "he": "חליטת תה ירוק לואיזה וליים", "d": "תה ירוק, לואיזה, נענע וליים", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז GT", "משלימים ל־⅔ במים קרים (או סודה)", "קישוט: פרוסת לימון · נענע טרייה"], "ing": ["קרח", "50 מ״ל תרכיז GT", "פרוסת לימון", "עשבי קישוט"], "fc": "3.25", "p": 20, "m": 81, "pr": "13.70"}, {"en": "Energy", "he": "חליטת תה ירוק ולמון גראס", "d": "תה ירוק, למון גראס, נענע ולימון", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז GT", "משלימים ל־⅔ במים קרים (או סודה)", "קישוט: פרוסת לימון · בזיליקום"], "ing": ["קרח", "50 מ״ל תרכיז GT", "פרוסת לימון", "עשבי קישוט"], "fc": "3.25", "p": 20, "m": 81, "pr": "13.70"}, {"en": "Consciousness", "he": "חליטת יסמין וליצ'י", "d": "תה יסמין וליצ׳י — רגיל או מוגז, ארומטי ועדין", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז GT", "משלימים ל־⅔ במים קרים (או סודה)", "קישוט: פרוסת לימון · נענע טרייה"], "ing": ["קרח", "50 מ״ל תרכיז GT", "פרוסת לימון", "עשבי קישוט"], "fc": "3.25", "p": 20, "m": 81, "pr": "13.70"}], "ac": "var(--terra)"}, {"n": "02", "t": "לימונדות", "he": "לימונדות", "p": "₪22", "drinks": [{"en": "לימונדת Fresh", "he": "לימונדת היביסקוס וליים", "d": "לימונדת היביסקוס וליים מרעננת", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז GT", "משלימים עד למעלה בלימונדה", "מערבבים בעדינות ומגישים"], "ing": ["קרח", "50 מ״ל תרכיז GT", "~250 מ״ל לימונדה"], "fc": "3.95", "p": 22, "m": 79, "pr": "14.69"}, {"en": "לימונדה מדברית", "he": "לימונדה מדברית", "d": "לימונדה על צמחי בר ישראליים", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז GT", "משלימים עד למעלה בלימונדה", "מערבבים בעדינות ומגישים"], "ing": ["קרח", "50 מ״ל תרכיז GT", "~250 מ״ל לימונדה"], "fc": "3.95", "p": 22, "m": 79, "pr": "14.69"}, {"en": "לימונדת Namastea", "he": "לימונדת צ'אי מסאלה", "d": "לימונדה על צ׳אי מסאלה", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז GT", "משלימים עד למעלה בלימונדה", "מערבבים בעדינות ומגישים"], "ing": ["קרח", "50 מ״ל תרכיז GT", "~250 מ״ל לימונדה"], "fc": "3.95", "p": 22, "m": 79, "pr": "14.69"}], "ac": "var(--energy)"}, {"n": "03", "t": "משקאות הדגל", "he": "משקאות הדגל", "p": "₪24–31", "drinks": [{"en": "מדברי אפרסק", "he": "חליטת אפרסק מדברית", "d": "משקה דגל על פירה אפרסק", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל פירה אפרסק", "מוסיפים 40 מ״ל תרכיז GT", "מוסיפים מים", "מקשטים לפי הטעם"], "ing": ["קרח", "40 מ״ל פירה אפרסק", "40 מ״ל תרכיז GT", "קישוט"], "fc": "4.80", "p": 31, "m": 82, "pr": "21.47"}, {"en": "Detox תות", "he": "חליטת תות לואיזה", "d": "משקה דגל על פירה תות", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל פירה תות", "מוסיפים 40 מ״ל תרכיז GT", "משלימים ל־⅔ במים", "מקשטים לפי הטעם"], "ing": ["קרח", "40 מ״ל פירה תות", "40 מ״ל תרכיז GT", "קישוט"], "fc": "4.80", "p": 31, "m": 82, "pr": "21.47"}, {"en": "Revive מנגו", "he": "חליטת מנגו סנצ'ה", "d": "משקה דגל על מנגו", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל פירה מנגו", "מוסיפים 40 מ״ל תרכיז GT", "משלימים ל־⅔ במים", "מקשטים לפי הטעם"], "ing": ["קרח", "40 מ״ל פירה מנגו", "40 מ״ל תרכיז GT", "קישוט"], "fc": "4.80", "p": 31, "m": 82, "pr": "21.47"}, {"en": "Fresh תפוח", "he": "חליטת תפוח היביסקוס", "d": "משקה דגל על מיץ תפוחים", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל מיץ תפוחים", "מוסיפים 40 מ״ל תרכיז GT", "משלימים ל־⅔ במים", "מקשטים לפי הטעם"], "ing": ["קרח", "40 מ״ל מיץ תפוחים", "40 מ״ל תרכיז GT", "קישוט"], "fc": "2.88", "p": 24, "m": 86, "pr": "17.46"}], "ac": "var(--revive)"}, {"n": "04", "t": "גזוז", "he": "גזוז", "p": "₪22–33", "drinks": [{"en": "Consciousness ליצ׳י", "he": "גזוז יסמין וליצ'י", "d": "גזוז תה יסמין וליצ׳י עם ליצ׳י טרי", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל מי ליצ׳י", "מוסיפים 40 מ״ל תרכיז GT", "משלימים ל־⅔ בסודה (כ־150 מ״ל)", "קישוט: 2 ליצ׳י"], "ing": ["קרח", "40 מ״ל מי ליצ׳י", "40 מ״ל תרכיז GT", "~150 מ״ל סודה", "2 ליצ׳י"], "fc": "3.08", "p": 25, "m": 85, "pr": "18.11"}, {"en": "גזוז מדברי אפרסק", "he": "גזוז מדברי ואפרסק", "d": "גזוז צמחי בר ואפרסק", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל פירה אפרסק", "מוסיפים 40 מ״ל תרכיז GT", "משלימים ל־⅔ בסודה (כ־150 מ״ל)", "מקשטים לפי הטעם"], "ing": ["קרח", "40 מ״ל פירה אפרסק", "40 מ״ל תרכיז GT", "~150 מ״ל סודה"], "fc": "4.80", "p": 33, "m": 83, "pr": "23.17"}, {"en": "גזוז Fresh תפוח", "he": "גזוז היביסקוס ותפוח", "d": "גזוז היביסקוס עם מיץ תפוחים", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל מיץ תפוחים", "מוסיפים 40 מ״ל תרכיז GT", "משלימים ל־⅔ בסודה (כ־150 מ״ל)", "מקשטים לפי הטעם"], "ing": ["קרח", "40 מ״ל מיץ תפוחים", "40 מ״ל תרכיז GT", "~150 מ״ל סודה"], "fc": "2.88", "p": 22, "m": 85, "pr": "15.76"}], "ac": "#7FA8B8"}, {"n": "05", "t": "אייס מאצ׳ה", "he": "אייס מאצ'ה", "p": "₪26–39", "drinks": [{"en": "Classic", "he": "אייס מאצ'ה קלאסי", "d": "אייס מאצ׳ה קלאסי", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "⅔ כוס חלב", "50 מ״ל מאצ׳ה (1.8 גרם)", "70 מ״ל קצף חלב"], "fc": "4.26", "p": 26, "m": 81, "pr": "17.77"}, {"en": "Mango", "he": "אייס מאצ'ה מנגו", "d": "אייס מאצ׳ה מנגו", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל פירה מנגו", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "40 מ״ל פירה מנגו", "⅔ כוס חלב", "50 מ״ל מאצ׳ה (1.8 גרם)", "70 מ״ל קצף חלב"], "fc": "6.46", "p": 39, "m": 80, "pr": "26.59"}, {"en": "Strawberry", "he": "אייס מאצ'ה תות", "d": "אייס מאצ׳ה פירה תות", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל פירה תות", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "40 מ״ל פירה תות", "⅔ כוס חלב", "50 מ״ל מאצ׳ה (1.8 גרם)", "70 מ״ל קצף חלב"], "fc": "6.46", "p": 39, "m": 80, "pr": "26.59"}, {"en": "Peach", "he": "אייס מאצ'ה אפרסק", "d": "אייס מאצ׳ה פירה אפרסק", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל פירה אפרסק", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "40 מ״ל פירה אפרסק", "⅔ כוס חלב", "50 מ״ל מאצ׳ה (1.8 גרם)", "70 מ״ל קצף חלב"], "fc": "6.46", "p": 39, "m": 80, "pr": "26.59"}, {"en": "Massala", "he": "אייס מאצ'ה מסאלה", "d": "אייס מאצ׳ה עם תרכיז מסאלה GT", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל תרכיז מסאלה GT", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "40 מ״ל תרכיז מסאלה GT", "⅔ כוס חלב", "50 מ״ל מאצ׳ה (1.8 גרם)", "70 מ״ל קצף חלב"], "fc": "6.86", "p": 37, "m": 78, "pr": "24.50"}, {"en": "אגבה על קרח", "he": "מאצ'ה אגבה על הקרח", "d": "אייס מאצ׳ה קליל עם אגבה על קרח", "st": ["ממלאים את הכוס בקרח", "מוסיפים 15 מ״ל סירופ אגבה", "משלימים ל־⅔ במים", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "⅔ כוס מים", "15 מ״ל סירופ אגבה", "50 מ״ל מאצ׳ה (1.8 גרם)", "70 מ״ל קצף חלב"], "fc": "2.85", "p": 26, "m": 87, "pr": "19.18"}], "ac": "var(--matcha)"}, {"n": "06", "t": "מאצ׳ה ספיישל", "he": "מאצ'ה — טעמים מיוחדים", "p": "₪28–29", "drinks": [{"en": "Vanilla", "he": "אייס מאצ'ה וניל", "d": "אייס מאצ׳ה וניל", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים מקל וניל", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "⅔ כוס חלב", "50 מ״ל מאצ׳ה (1.8 גרם)", "מקל וניל", "70 מ״ל קצף חלב"], "fc": "4.56", "p": 28, "m": 81, "pr": "19.17"}, {"en": "Pistachio", "he": "אייס מאצ'ה פיסטוק", "d": "אייס מאצ׳ה פיסטוק", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים פיסטוק גרוס", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "⅔ כוס חלב", "50 מ״ל מאצ׳ה (1.8 גרם)", "פיסטוק גרוס", "70 מ״ל קצף חלב"], "fc": "5.46", "p": 28, "m": 77, "pr": "18.27"}, {"en": "שומשום שחור", "he": "אייס מאצ'ה שומשום שחור", "d": "אייס מאצ׳ה שומשום שחור", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים שומשום שחור", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "⅔ כוס חלב", "50 מ״ל מאצ׳ה (1.8 גרם)", "שומשום שחור", "70 מ״ל קצף חלב"], "fc": "5.06", "p": 28, "m": 79, "pr": "18.67"}, {"en": "Coffee", "he": "אייס מאצ'ה קפה", "d": "אייס מאצ׳ה קפה", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים שוט אספרסו", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "⅔ כוס חלב", "50 מ״ל מאצ׳ה (1.8 גרם)", "שוט אספרסו", "70 מ״ל קצף חלב"], "fc": "5.26", "p": 29, "m": 79, "pr": "19.32"}, {"en": "Banana", "he": "אייס מאצ'ה בננה", "d": "אייס מאצ׳ה בננה", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "מוסיפים פירה בננה", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "⅔ כוס חלב", "50 מ״ל מאצ׳ה (1.8 גרם)", "פירה בננה", "70 מ״ל קצף חלב"], "fc": "4.76", "p": 28, "m": 80, "pr": "18.97"}], "ac": "#8C8C7A"}, {"n": "07", "t": "מאצ׳ה קוקוס", "he": "מאצ'ה קוקוס", "p": "₪32–44", "drinks": [{"en": "אגבה קלאסי", "he": "מאצ'ה קוקוס אגבה", "d": "מאצ׳ה קוקוס אגבה קלאסי", "st": ["ממלאים את הכוס בקרח", "מוסיפים 15 מ״ל סירופ אגבה", "משלימים ל־⅔ במי קוקוס (כ־150 מ״ל)", "מוסיפים קרם קוקוס (70 מ״ל)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)"], "ing": ["קרח", "15 מ״ל סירופ אגבה", "~150 מ״ל מי קוקוס", "70 מ״ל קרם קוקוס", "50 מ״ל מאצ׳ה (1.8 גרם)"], "fc": "4.04", "p": 34, "m": 86, "pr": "24.77"}, {"en": "Lychee", "he": "מאצ'ה קוקוס ליצ'י", "d": "מאצ׳ה קוקוס ליצ׳י", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל מי ליצ׳י", "משלימים ל־⅔ במי קוקוס (כ־150 מ״ל)", "מוסיפים קרם קוקוס (70 מ״ל)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)"], "ing": ["קרח", "40 מ״ל מי ליצ׳י", "~150 מ״ל מי קוקוס", "70 מ״ל קרם קוקוס", "50 מ״ל מאצ׳ה (1.8 גרם)"], "fc": "4.07", "p": 32, "m": 85, "pr": "23.05"}, {"en": "Strawberry", "he": "מאצ'ה קוקוס תות", "d": "מאצ׳ה קוקוס תות", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל פירה תות", "משלימים ל־⅔ במי קוקוס (כ־150 מ״ל)", "מוסיפים קרם קוקוס (70 מ״ל)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)"], "ing": ["קרח", "40 מ״ל פירה תות", "~150 מ״ל מי קוקוס", "70 מ״ל קרם קוקוס", "50 מ״ל מאצ׳ה (1.8 גרם)"], "fc": "5.79", "p": 44, "m": 84, "pr": "31.50"}, {"en": "Mango", "he": "מאצ'ה קוקוס מנגו", "d": "מאצ׳ה קוקוס מנגו", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל פירה מנגו", "משלימים ל־⅔ במי קוקוס (כ־150 מ״ל)", "מוסיפים קרם קוקוס (70 מ״ל)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)"], "ing": ["קרח", "40 מ״ל פירה מנגו", "~150 מ״ל מי קוקוס", "70 מ״ל קרם קוקוס", "50 מ״ל מאצ׳ה (1.8 גרם)"], "fc": "5.79", "p": 44, "m": 84, "pr": "31.50"}, {"en": "Peach", "he": "מאצ'ה קוקוס אפרסק", "d": "מאצ׳ה קוקוס אפרסק", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל פירה אפרסק", "משלימים ל־⅔ במי קוקוס (כ־150 מ״ל)", "מוסיפים קרם קוקוס (70 מ״ל)", "מוזגים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)"], "ing": ["קרח", "40 מ״ל פירה אפרסק", "~150 מ״ל מי קוקוס", "70 מ״ל קרם קוקוס", "50 מ״ל מאצ׳ה (1.8 גרם)"], "fc": "5.79", "p": 44, "m": 84, "pr": "31.50"}], "ac": "#5FA89B"}, {"n": "08", "t": "צ׳אי מסאלה", "he": "צ'אי מסאלה", "p": "₪24–32", "drinks": [{"en": "אייס מסאלה קלאסי", "he": "אייס צ'אי מסאלה קלאסי", "d": "צ׳אי מסאלה עשיר עם קצף חלב וקינמון", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל תרכיז מסאלה GT", "מוסיפים קצף חלב", "מפזרים קינמון"], "ing": ["קרח", "⅔ כוס חלב", "50 מ״ל מסאלה GT", "70 מ״ל קצף חלב", "קינמון"], "fc": "5.57", "p": 28, "m": 77, "pr": "18.16"}, {"en": "על קרח", "he": "צ'אי מסאלה על הקרח", "d": "צ׳אי מסאלה קליל ומרענן על מים", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ במים", "מוזגים 50 מ״ל תרכיז מסאלה GT", "מוסיפים קצף חלב נדיב"], "ing": ["קרח", "⅔ כוס מים", "50 מ״ל מסאלה GT", "70 מ״ל קצף חלב"], "fc": "3.70", "p": 24, "m": 82, "pr": "16.64"}, {"en": "דירטי צ׳אי", "he": "דירטי צ'אי", "d": "צ׳אי מסאלה עם שוט אספרסו וקצף חלב עשיר", "st": ["מכינים שוט אספרסו", "ממלאים את הכוס בקרח", "משלימים ל־⅔ בחלב", "מוזגים 50 מ״ל מסאלה GT + האספרסו", "מוסיפים קצף חלב נדיב"], "ing": ["קרח", "⅔ כוס חלב", "50 מ״ל מסאלה GT", "שוט אספרסו", "70 מ״ל קצף חלב"], "fc": "6.57", "p": 32, "m": 76, "pr": "20.55"}, {"en": "טוניק תפוז מיובש", "he": "צ'אי מסאלה תפוז וטוניק", "d": "צ׳אי מסאלה מוגז עם טוניק ותפוז מיובש", "st": ["ממלאים את הכוס בקרח", "מוזגים 50 מ״ל תרכיז מסאלה GT", "משלימים בטוניק (כ־150 מ״ל)", "מקשטים בפרוסת תפוז מיובש"], "ing": ["קרח", "50 מ״ל מסאלה GT", "~150 מ״ל טוניק", "תפוז מיובש"], "fc": "4.75", "p": 26, "m": 78, "pr": "17.28"}, {"en": "טוניק ורדים ורוד", "he": "צ'אי מסאלה פינק טוניק", "d": "צ׳אי מסאלה עם טוניק ורדים או אשכוליות", "st": ["ממלאים את הכוס בקרח", "מוזגים 50 מ״ל תרכיז מסאלה GT", "משלימים בטוניק ורדים או אשכוליות (כ־150 מ״ל)"], "ing": ["קרח", "50 מ״ל מסאלה GT", "~150 מ״ל טוניק ורדים"], "fc": "4.75", "p": 24, "m": 77, "pr": "15.59"}, {"en": "מיץ תפוזים", "he": "צ'אי מסאלה ומיץ תפוזים", "d": "צ׳אי מסאלה עם מיץ תפוזים סחוט", "st": ["ממלאים את הכוס בקרח", "מוזגים 50 מ״ל תרכיז מסאלה GT", "משלימים במיץ תפוזים סחוט (כ־150 מ״ל)"], "ing": ["קרח", "50 מ״ל מסאלה GT", "~150 מ״ל מיץ תפוזים"], "fc": "5.25", "p": 28, "m": 78, "pr": "18.48"}], "ac": "var(--nama)"}, {"n": "09", "t": "קולד פואם", "he": "צ'אי מסאלה קולד פואם", "p": "₪28–32", "drinks": [{"en": "Vanilla", "he": "צ'אי מסאלה קולד פואם וניל", "d": "צ׳אי מסאלה עם קצף קר וניל", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ במים", "מוזגים 50 מ״ל תרכיז מסאלה GT", "מכתירים בקצף קר וניל", "מקשטים במקל וניל"], "ing": ["קרח", "⅔ כוס מים", "50 מ״ל מסאלה GT", "70 מ״ל קצף קר", "תמצית וניל"], "fc": "4.00", "p": 28, "m": 83, "pr": "19.73"}, {"en": "Pistachio", "he": "צ'אי מסאלה קולד פואם פיסטוק", "d": "צ׳אי מסאלה עם קצף קר ופיסטוק גרוס", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ בחלב", "מוזגים 50 מ״ל תרכיז מסאלה GT", "מכתירים בקצף קר חלבי", "מפזרים פיסטוק גרוס"], "ing": ["קרח", "⅔ כוס חלב", "50 מ״ל מסאלה GT", "70 מ״ל קצף קר", "פיסטוק גרוס"], "fc": "4.90", "p": 30, "m": 81, "pr": "20.52"}, {"en": "קוקוס תאילנדי", "he": "צ'אי תאילנדי קוקוס קולד פואם", "d": "צ׳אי מסאלה עם קצף קר קוקוס, בסגנון תאילנדי", "st": ["ממלאים את הכוס בקרח", "משלימים במי קוקוס (כ־150 מ״ל)", "מוזגים 50 מ״ל תרכיז מסאלה GT", "מכתירים בקצף קר קוקוס (70 מ״ל)"], "ing": ["קרח", "~150 מ״ל מי קוקוס", "50 מ״ל מסאלה GT", "70 מ״ל קרם קוקוס"], "fc": "4.90", "p": 32, "m": 82, "pr": "22.22"}, {"en": "Banana", "he": "צ'אי מסאלה קולד פואם בננה", "d": "צ׳אי מסאלה עם קצף קר בננה", "st": ["ממלאים את הכוס בקרח", "משלימים ל־⅔ בחלב", "מוזגים 50 מ״ל מסאלה GT + פירה בננה", "מכתירים בקצף קר חלבי"], "ing": ["קרח", "⅔ כוס חלב", "50 מ״ל מסאלה GT", "פירה בננה", "70 מ״ל קצף קר"], "fc": "4.20", "p": 31, "m": 84, "pr": "22.07"}], "ac": "#B0793B"}, {"n": "10", "t": "אובה", "he": "אובה", "p": "₪28–31", "drinks": [{"en": "Strawberry", "he": "אייס אובה תות", "d": "אייס אובה תות", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל פירה תות", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל אובה מוכן (2 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "40 מ״ל פירה תות", "⅔ כוס חלב", "50 מ״ל אובה (2 גרם)", "70 מ״ל קצף חלב"], "fc": "5.22", "p": 30, "m": 79, "pr": "20.20"}, {"en": "Mango", "he": "אייס אובה מנגו", "d": "אייס אובה מנגו", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל פירה מנגו", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל אובה מוכן (2 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "40 מ״ל פירה מנגו", "⅔ כוס חלב", "50 מ״ל אובה (2 גרם)", "70 מ״ל קצף חלב"], "fc": "5.22", "p": 30, "m": 79, "pr": "20.20"}, {"en": "Peach", "he": "אייס אובה אפרסק", "d": "אייס אובה אפרסק", "st": ["ממלאים את הכוס בקרח", "מוסיפים 40 מ״ל פירה אפרסק", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל אובה מוכן (2 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "40 מ״ל פירה אפרסק", "⅔ כוס חלב", "50 מ״ל אובה (2 גרם)", "70 מ״ל קצף חלב"], "fc": "5.22", "p": 30, "m": 79, "pr": "20.20"}, {"en": "Massala", "he": "אייס אובה מסאלה", "d": "אייס אובה מסאלה", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל תרכיז מסאלה GT", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל אובה מוכן (2 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "50 מ״ל מסאלה GT", "⅔ כוס חלב", "50 מ״ל אובה (2 גרם)", "70 מ״ל קצף חלב"], "fc": "6.27", "p": 31, "m": 76, "pr": "20.00"}, {"en": "Matcha", "he": "אייס אובה מאצ'ה", "d": "אייס אובה מאצ׳ה", "st": ["ממלאים את הכוס בקרח", "מוסיפים 50 מ״ל מאצ׳ה מוכן (1.8 גרם אבקה)", "משלימים ל־⅔ בחלב (או חלב צמחי)", "מוזגים 50 מ״ל אובה מוכן (2 גרם אבקה)", "מוסיפים קצף חלב מלמעלה"], "ing": ["קרח", "50 מ״ל מאצ׳ה (1.8 גרם)", "⅔ כוס חלב", "50 מ״ל אובה (2 גרם)", "70 מ״ל קצף חלב"], "fc": "4.96", "p": 28, "m": 79, "pr": "18.77"}], "ac": "var(--ube)"}];

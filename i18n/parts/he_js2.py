# -*- coding: utf-8 -*-
"""Hebrew for drink names, descriptions and flavour copy in the JS layer."""

EN2HE = {
# ── collection titles (COLS[].t) ────────────────────────────────────────
"Iced Tea": "חליטות קרות",
"Ice Matcha": "אייס מאצ׳ה",
"Matcha Specials": "מאצ׳ה ספיישל",
"Matcha Coconut": "מאצ׳ה קוקוס",
"Chai Massala": "צ׳אי מסאלה",
"Cold Foam": "קולד פואם",

# ── COLS drink descriptions (d.d) ───────────────────────────────────────
"Hibiscus-lime infusion, still or sparkling, with lemon and mint":
    "חליטת היביסקוס וליים, רגילה או מוגזת, עם לימון ונענע",
...
"Light agave iced matcha on the rocks": "אייס מאצ׳ה קליל עם אגבה על קרח",
"Rich chai massala with milk foam and cinnamon": "צ׳אי מסאלה עשיר עם קצף חלב וקינמון",
"Light, refreshing chai massala on water": "צ׳אי מסאלה קליל ומרענן על מים",
"Chai massala with an espresso shot and rich milk foam":
    "צ׳אי מסאלה עם שוט אספרסו וקצף חלב עשיר",
"Sparkling chai massala with tonic and dried orange":
    "צ׳אי מסאלה מוגז עם טוניק ותפוז מיובש",
"Chai massala with rose or grapefruit tonic": "צ׳אי מסאלה עם טוניק ורדים או אשכוליות",
"Chai massala with fresh orange juice": "צ׳אי מסאלה עם מיץ תפוזים סחוט",
"Chai massala with vanilla cold foam": "צ׳אי מסאלה עם קצף קר וניל",
"Chai massala with cold foam and crushed pistachio":
...
"peach ube iced": "אייס אובה אפרסק",
"Iced ube massala": "אייס אובה מסאלה",
"Iced ube matcha": "אייס אובה מאצ׳ה",
"Iced ube strawberry": "אייס אובה תות",

# ── MK: the second (flavour-card) catalogue ─────────────────────────────
"Detox iced tea \\u2014 still or sparkling": "חליטת Detox קרה — רגילה או מוגזת",
...
"Chai & dry-orange tonic": "צ׳אי וטוניק תפוז מיובש",
"Chai cold foam vanilla": "צ׳אי קולד פואם וניל",
...
"Every iced tea doubles as a gazoz: same recipe, soda instead of water.":
    "כל חליטה קרה היא גם גזוז: אותו מתכון, סודה במקום מים.",
...
"Foam": "קצף", "Milk": "חלב", "Soda": "סודה", "Water": "מים",
"Espresso": "אספרסו", "Agave": "אגבה", "Fruit": "פרי", "Finish": "סיום",

# ── UI bits rendered from JS ────────────────────────────────────────────
"Menu drinks it makes \\u2014 tap for recipe": "המשקאות שיוצאים ממנו — הקליקו למתכון",
"Food cost \\u20aa": "עלות חומר גלם ₪",
"Expand all": "פתחו הכול",
"Collapse all": "סגרו הכול",
" recipes \\u2192": " מתכונים ←",

# ── partner-form mail body labels ───────────────────────────────────────
"Venue / company: ": "שם העסק: ",
"Name: ": "שם: ",
"Role: ": "תפקיד: ",
"City: ": "עיר: ",
"Phone: ": "טלפון: ",
"Email: ": "אימייל: ",
"Interested in: ": "מתעניין ב: ",
"Message:": "הודעה:",
"GT Everyday — partner application — ": "GT Everyday — בקשת שיתוף פעולה — ",
}
